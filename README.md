...
Dal 2026-09-07 la testata del sito ha **tre porte**, ratificate dal Direttore (SOLDI
ed EGO al mattino, CHILL la sera dello stesso giorno):
...
| **CHILL** — *per l'aria* | ciano `#16E0DC` | `chill.html` | l'aria: chill, AURA, Radio 77 |

**Perché porte e non un menu.** Il sito faceva più mestieri con una voce sola. Adesso
chi arriva sceglie prima *di chi è* la cosa che sta guardando: se è per lui, se è
del Direttore, o se è aria. La riga sotto la testata elenca le stanze **della porta
in cui si è**, e cambia con la porta. CHILL ha il ciano perché era già il suo colore
in casa, non uno nuovo.

**Progetti · Divulgazione** non sono in testata: stanno nella mappa a piè di
pagina, raggiungibile dal rinvio «la galassia ↓». Non sono una quarta porta — sono
stanze che non appartengono a nessuna delle tre. Chill è entrato in testata la sera
del 07/09 e resta anche nella mappa: nessuna pagina è diventata orfana.
...
⚠️ **Se aggiungi una pagina**, decidi a quale porta appartiene e mettila nella riga
delle stanze giusta (`nav.menu.soldi`, `nav.menu.ego` o `nav.menu.chill`). Una pagina
senza porta esiste ma non si raggiunge: è successo a `divulgazione.html`, che il 07/09
non era in nessuno dei posti.
